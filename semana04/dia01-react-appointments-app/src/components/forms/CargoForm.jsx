...
const CargoForm = ({ appointment, onSaveAppointment }) => {
  ...
  return (
    <form className="max-w-sm mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg" onSubmit={handleSubmit}>
      <div className="mb-5">
        <label htmlFor="carNom" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nombre Cargo</label>
        <input
          type="text"
          id="carNom"
          name="carNom"
      ...
      <div className="mb-5">
        <label htmlFor="cargoDes" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Descripcion del Cargo</label>
        <input
          type="text"
          id="cargoDes"
          name="cargoDes"
      ...
      <div className="mb-5 grid grid-cols-1 grid-rows-2 gap-6 place-items-center">
        <div>
          <label htmlFor="carEst" className="mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            Cargo Status:
          </label>
